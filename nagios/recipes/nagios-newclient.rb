...
template "/etc/nagios3/conf.d/hosts.d/utility/utility.cfg" do
  source "tata-hosts.erb"
  variables( :a => 'jenkins', :b => "30.0.30.71", :c => 'openvpnbastion', :d => "30.0.20.169" )
end

#template "/etc/nagios3/conf.d/hosts.d/utility/openvpn.cfg" do
#  source "tata-hosts.erb"
...
template "/etc/nagios3/conf.d/hostgroups.d/utility/utility.cfg" do
...
template "/etc/nagios3/conf.d/services.d/utility/utility.cfg" do
